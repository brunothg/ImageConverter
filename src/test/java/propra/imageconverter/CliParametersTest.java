...
public class CliParametersTest {
	...
	private static final String[] ARGUMENTS = new String[] { "--input=../KE1_TestBilder/test_01_uncompressed.tga",
			"--output=../KE1_Konvertiert/test_02.propra", "--encode-base-32", "--decode-base-32",
			"--encode-base-n=0987abc4321xyz56" };
	...
	public void testBaseN() throws Exception {
		...
		assertArrayEquals(new char[] { '0', '9', '8', '7', 'a', 'b', 'c', '4', '3', '2', '1', 'x', 'y', 'z', '5', '6' },
				parameters.getBaseNEncodeAlphabet());
	}
}
